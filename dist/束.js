...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/幹.coffee");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _coffee__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./簡繁處理.coffee */ \"./src/簡繁處理.coffee\");\n\n\nwindow.onload = function() {\n  var a, i, j, len, v, word;\n  a = $('#全, #全 *').contents().filter(function() {\n    return this.nodeType === 3;\n  });\n  for (j = 0, len = a.length; j < len; j++) {\n    i = a[j];\n    word = i.nodeValue;\n    i = $(i);\n    if (/^( |\\n|\\t)*$/.test(word)) {\n      continue;\n    }\n    i.after(`<span v-if='lang==\"cht\"'>${word}</span>`);\n    i.after(`<span v-if='lang==\"chs\"'>${Object(_coffee__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(word)}</span>`);\n    i.remove();\n  }\n  v = new Vue({\n    el: '#全',\n    data: {\n      lang: 'cht'\n    }\n  });\n  $('#語言--cht').click(function() {\n    return v.lang = 'cht';\n  });\n  return $('#語言--chs').click(function() {\n    return v.lang = 'chs';\n  });\n};\n\n\n//# sourceURL=webpack:///./src/%E5%B9%B9.coffee?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _transverter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./transverter.js */ \"./src/transverter.js\");\nvar 簡化;\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (簡化 = function(s) {\n  return Object(_transverter_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])()({\n    str: s\n  });\n});\n\n\n//# sourceURL=webpack:///./src/%E7%B0%A1%E7%B9%81%E8%99%95%E7%90%86.coffee?");
